...
void hrnInit(
    ...
    const char *architecture, const char *testPath, const char *testConfig, const char *testUser, const char *testVm,
    const char *testPgVersion, const char *testDataPath, const char *testRepoPath);
